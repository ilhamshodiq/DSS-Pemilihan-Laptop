    ...
    <div class="d-flex bg-dark text-white" id="wrapper">
        ...
        <div id="page-content-wrapper">
            ...
            <div class="container-sm">
                ...
                <a class="btn btn-primary mb-2 btn-sm" href="form_input/formmatrix.php" role="button">Tambah</a>
                    ...
                    <tbody>
                        <?php while ($data = $query->fetch_array()) { ?>
                            <tr>
                                ...
                                <td>
                                    <form action="form_edit/formmatrix.php?id_matrix=<?php echo $data['id_matrix'] ?>" method="post">
                                        <input type="hidden" name="id_matrix">
                                        <input class="btn btn-success btn-sm" type="submit" value="edit">
                                    </form>
                                    <p></p>
                                    <form action="aksi_hapus/deletematrix.php" method="post">
                                        <input type="hidden" name="id_matrix" value="<?php echo $data['id_matrix'] ?>">
