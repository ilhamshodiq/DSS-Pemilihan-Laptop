...
<body>
    ...
    $sql = "SELECT * FROM alternatif WHERE id_laptop = '$id_laptop'";
            ...
            <div class="container-sm">
                ...
                ?>
                        <form action="" method="post">
                            <div class="mb-3">
                                <label for="inputidlaptop" class="form-label">id Laptop</label>
                                <input type="text" class="form-control" id="inputidlaptop" name="id_laptop" value="<?php echo $data['id_laptop'] ?>">
                            </div>
                            <div class=" mb-3">
                                <label for="inputmerklaptop" class="form-label">Merk Laptop</label>
                                <input type="text" class="form-control" id="inputmerklaptop" name="merk_laptop" value="<?php echo $data['merk_laptop'] ?>">
                            </div>
                ...
                if (isset($_POST['edit'])) {
                    ...
                    $sql = "UPDATE alternatif SET merk_laptop = '$merk_laptop' WHERE id_laptop = '$id_laptop'";
                    $query = $koneksi->query($sql);
                    if ($query) {
