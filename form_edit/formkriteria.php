...
<head>
    ...
    <title>Menu Data Kriteria</title>
</head>
    ...
    <div class="d-flex bg-dark text-white" id="wrapper">
        ...
        <div class="bg-dark" id="sidebar-wrapper">
            <div class="list-group list-group-flush my-3">
                ...
                <a href="../dtkriteria.php" class="active list-group-item list-group-item-action bg-transparent second-text fw-bold"></i>Data Kriteria</a>
            ...
            <div class="container-sm">
                ...
                ?>
                        <form action="" method="post">
                            ...
                            <div class="mb-3">
                                <label for="inputnamakriteria" class="form-label">Nama Kriteria</label>
                                <input type="text" class="form-control" id="inputnamakriteria" name="nm_kriteria" value="<?php echo $data['nm_kriteria'] ?>">
                            </div>
                ...
                if (isset($_POST['edit'])) {
                    ...
                    $sql = "UPDATE kriteria SET nm_kriteria = '$nm_kriteria' WHERE id_kriteria = '$id_kriteria'";
                    $query = $koneksi->query($sql);
                    if ($query) {
