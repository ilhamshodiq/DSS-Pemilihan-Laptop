...
<body>
    ...
    $sql = "SELECT * FROM matrixkeputusan WHERE id_matrix = '$id_matrix'";
    ...
    <div class="d-flex bg-dark text-white" id="wrapper">
        ...
        <div class="bg-dark" id="sidebar-wrapper">
            <div class="list-group list-group-flush my-3">
                ...
                <a href="../dtmatrix.php" class="active list-group-item list-group-item-action bg-transparent second-text fw-bold"></i>Data Matrix</a>
            ...
            <div class="container-sm">
                ...
                ?>
                        <form action="" method="post">
                            <div class="mb-3">
                                <label for="inputidmatrix" class="form-label">id Matrix</label>
                                <input type="text" class="form-control" id="inputidmatrix" name="id_matrix" value="<?php echo $data['id_matrix'] ?>">
                            </div>
                            <div class="mb-3">
                                <div class="mb-3">
                                    <label for="inputidalternatif" class="form-label">id Alternatif</label>
                                    <input type="text" class="form-control" id="inputidalternatif" name="id_alternatif" value="<?php echo $data['id_alternatif'] ?>">
                                </div>
                            ...
                            <a class="btn btn-danger" href="../dtmatrix.php" role="button">Cancel</a>
                        </form>
                <?php
                    }
                }
                if (isset($_POST['edit'])) {
                    ...
                    $sql = "UPDATE matrixkeputusan SET id_alternatif = '$id_alternatif', id_bobot = '$id_bobot', id_skala = '$id_skala' WHERE id_matrix = '$id_matrix'";
                    $query = $koneksi->query($sql);
                    if ($query) {
