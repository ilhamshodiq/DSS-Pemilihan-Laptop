            ...
            <div class="container-sm">
                ...
                <form action="insertmatrix.php" method="post">
                    <div class="mb-3">
                        ...
                        <input type="text" class="form-control" id="inputidmatrix" name="id_matrix">
                    </div>
                    <div class="mb-3">
                        <div class="mb-3">
                            <label for="inputidalternatif" class="form-label">id Alternatif</label>
                            <input type="text" class="form-control" id="inputidalternatif" name="id_alternatif">
                        </div>
                        <label for="inputidbobot" class="form-label">id Bobot</label>
                        <input type="text" class="form-control" id="inputidbobot" name="id_bobot">
                    </div>
                    <div class="mb-3">
                        <label for="inputidskala" class="form-label">id Skala</label>
                        <input type="text" class="form-control" id="inputidskala" name="id_skala">
                    </div>
